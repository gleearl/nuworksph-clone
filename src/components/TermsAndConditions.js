...
function TermsAndConditions() {
  return (
    <Container className="my-5 py-5">
      <img src="https://nuworks.ph/static/images/logo/terms_and_conditions.png" alt="" width="550px" />
      <ol className="mt-5">
        <li>
          <p>Terms</p>
        ...
        <li>
          ...
          <ol className="list-alpha">
            <li>Permission is granted to temporarily download one copy of the materials (information or software) on the company web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</li>
              <ol className="list-roman">
                <li>modify or copy the materials;</li>
                <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
                <li>attempt to decompile or reverse engineer any software contained on the company web site;</li>
